#!/bin/ksh
echo "RCS $Id: oem_ref_mptr799_ftp_trp_source_file.ksh,v 1.3 2026/08/18 18:06:21 rj132422 Exp rj132422 $"
set -xv
#*****************************************************************************************
# PROCNAME oem_ref_mptr799_ftp_trp_source_file.ksh                                            
# PURPOSE  Transfer the latest US TRP File from Mitchell SFTP Server
...
#STEP Step010R
  ...
  oem_job_status_update.ksh "R" "${STEPNAME} oem_ref_mptr799_ftp_trp_source_file"
  #**************************************************************************************
...
#STEP Step020R
  ...
  then
    ...
    then
      ...
      echo "\nThe US TRP file has been transferred to the Network \n"               > ${MAIL_TEXT}
      ...
      echo "   1. MOVE this file into: " '\\\dept01nas\\dept\\PubTeams\\TRP\\' >> ${MAIL_TEXT}
      ...
      then
        ...
        mailx -s "TEST - ${MAIL_SUBJECT} " "RACEBatchDL@mitchell.com" < ${MAIL_TEXT}
      else
...
#*****************************************************************************************
# END oem_ref_mptr799_ftp_trp_source_file.ksh
#*****************************************************************************************
