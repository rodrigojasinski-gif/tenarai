#!/bin/ksh
 . race_oem.ksh
#$Id: mptr495.ksh,v 1.11 2024/07/17 00:53:59 pg2697 Exp $
#***************************************************************************
# Job Description: RACE OEM Parts Price Reformat: TOY 044 CA
#***************************************************************************
export RESTART=$1
...
exec_restart.ksh oem_ref_toy_ca_prep.ksh ${RESTART} >> ${JOBLOGNAME}
RETURN_CODE=$?
