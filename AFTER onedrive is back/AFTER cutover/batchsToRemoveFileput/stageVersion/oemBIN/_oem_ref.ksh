...
#   -v  echo shell input lines as they are read.
#   -x  echo commands and their arguments as they are executed.
#*****************************************************************************************
set -x
...
#STEP Step020R
  ...
  #     Make sure file is void of ASCII control characters and of unechoable
    ...
    then
      ...
      then 
        ...
        then  
          ...
          # was file created?
          RECCNT=$(wc -l ${STEP020_FILEIN_CONV} | awk ' {echo $1}' )
          if [ "${RECCNT}" = "0" ]
          then
               echo "\n\n
                     ********** E R R O R ******************************************
