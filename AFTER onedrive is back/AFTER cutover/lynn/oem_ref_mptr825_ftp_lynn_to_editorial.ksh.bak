#!/bin/ksh
echo "RCS $Id: oem_ref_mptr825_ftp_lynn_to_editorial.ksh,v 1.1 2023/06/27 23:17:48 pg2697 Exp rj132422 $"
set -xv
#*****************************************************************************************
...
#STEP Step002R
  ...
  then
    ...
    fileput.exp ${SOURCE_FILE} ${INPUT_FILE_NAME} ${NOVELL}oem_research | tee ${FTP_LOGFILE}
