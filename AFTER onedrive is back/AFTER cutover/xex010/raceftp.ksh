#!/bin/ksh
#$Id: raceftp.ksh,v 1.8 2026/08/07 00:30:59 pb0690 Exp rj132422 $
###########################################################################
#
#   DESCRIPTION
...
# rj132422 - SFTP user on ftp-ssh: prod logs in as race_b1; dev uses the job account (empty = current behavior)
if [ "$ACT_LVL" = "prod" ]
then
   export FTP_SFTP_USER="race_b1@"
else
   export FTP_SFTP_USER=""
fi
