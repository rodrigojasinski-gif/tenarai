...
then
   ...
   export PATH=/home/production.int/svc-apd-race-prd:/prod/race/oem/bin:/prod/race/share/bin:$PATH
else
...
export LOG=$RACE/log # Added to prevent abend due missing variable in Linux
