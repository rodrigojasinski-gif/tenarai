...
# rj132422 - fall back to a private log when the caller does not set $LOG (the redirect below would fail otherwise)
[ -n "$LOG" ] || { LOG=${RACE}/log/${JOBNAME}_email_rpt_$$.sqlout; LOG_TMP=Y; }
: > "$LOG"
