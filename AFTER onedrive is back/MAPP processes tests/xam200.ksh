...
# Change rj132422 - 20260424 - AES-XXXX - Load configurable NFS path for MAPP/ALTP
...
#********************************************************************
    ...
    if [ ! -s ${ZIPFILE} ]
    then
# Change rj132422 - 20260424 - AES-XXXX - AIX->RHEL: use print for reliable \n handling on ksh93
       print "\n*********************************************************************************"
...
# Change rj132422 - 20260424 - AES-XXXX - Remove prod3nt dependency; use NFS-mounted path
...
# Change rj132422 - 20260424 - AES-XXXX - AIX->RHEL: quote vars and use [[ ]] for safe test
    if [[ "$reccnt1" -eq 0 ]]
