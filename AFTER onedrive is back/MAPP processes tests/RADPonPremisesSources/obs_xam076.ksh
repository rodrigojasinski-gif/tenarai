#!/bin/ksh
 echo "$Id: xam076.ksh,v 1.1 2002/03/07 23:10:21 jn0132 Exp $"
############################################################################
...
#*---------------------------------------------------------
     ...
     export DD_NOVELDSK=mapp02.dat
     export DD_UNXDISK=$RACE/dat/${JOBNAME}_trans02.xfr 
...
#* maybe check for empty and abend if if so
...
#STEP Step010R 
    ...
    echo "    Start   ${STEPNAME}           "$(date)
#*---------------------------------------------------------
#*    STEP010R  COPY SPECIAL MAPP UPLOAD TRANSACTIONS FILE
#*              TO GDG.
#*---------------------------------------------------------
                                                      
    export DD_SYSUT1=$RACE/dat/${JOBNAME}_trans02.xfr
    export DD_CATUT1=$RACE/tmp/${JOBNAME}_trans02.tmp
...
#*---------------------------------------------------------
    ...
    export DD_FILEOUT=$( setgdg.ksh \
           "$RACE/dat/${JOBNAME}_trans02.dat(+1)" NEW 4 )
