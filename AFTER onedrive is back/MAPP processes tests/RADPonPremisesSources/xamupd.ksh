...
############################################################################
  ...
  fileget.exp $NTFILE $UNXFILE $NTDIR ascii | tee $FTPLOG

  ntcount=$( grep 'Information ret' $FTPLOG | awk '{print $1}')
  unixoffset=$(wc -l $UNXFILE | awk '{print $1}')
  let ntcountoffset=$ntcount-$unixoffset 
  unixcount=$(wc -c $UNXFILE | awk '{print $1}')


  if [ ntcountoffset -eq unixcount ]
    then
...
#********************************************************************
  ...
  fileput.exp $FTPFILE ${QUALIFIER}_rpt_prov.txt ${NOVELL}altp ascii | tee $FTPLOG
...
#********************************************************************
  ...
  fileput.exp $FTPFILE ${QUALIFIER}_partver_sum.txt ${NOVELL}altp/Internal_Rpts ascii | tee $FTPLOG
...
#********************************************************************
  ...
  fileput.exp $FTPFILE ${QUALIFIER}_updt_sum.txt ${NOVELL}altp/Internal_Rpts ascii | tee $FTPLOG
