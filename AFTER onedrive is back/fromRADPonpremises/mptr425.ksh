#!/bin/ksh
 . race_oem.ksh
#$Id: mptr425.ksh,v 1.12 2024/01/18 22:40:55 pb0690 Exp $
#********************************************************************
# Job Description: RACE OEM Parts Price Reformat: FOR 002 CA
#********************************************************************
export RESTART=$1
...
#Pre-processor: Gets rid of older files not needed on Mitchell server
exec_restart.ksh oem_ref_mptr425_ftp_clean_files.ksh ${RESTART} >> ${JOBLOGNAME}
RETURN_CODE=$?
