...
#   use Korn shell '  grep' command to get job parm values
    ...
    FTP_MACHINE=`     grep $JOBNAME.ksh $RACE/prm/zxex000.prm |awk '{print $5}'`
    FTP_DEST_PATH=`   grep $JOBNAME.ksh $RACE/prm/zxex000.prm |awk '{print $6}'`
    ...
    export SQL_FTP_MACHINE=$FTP_MACHINE
    export SQL_FTP_DEST_PATH=$FTP_DEST_PATH
