...
export LOG=/tmp/email_rpt_$$.sqlout
: > $LOG
...
# rj132422 - Cat-back the captured sqlplus output (banner, WARNING, PL/SQL
# rj132422 - completion, disconnect) so it appears in the parent job log.
[ -s "$LOG" ] && cat "$LOG"
rm -f "$LOG"
